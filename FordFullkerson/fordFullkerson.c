/* FordFullkerson
*    Recebe a entrada no algoritmo e determina qual o fluxo máximo entre as
* origens e os destinos, sem levar em conta qualquer tipo de restrição de rotas,
* apenas aplica FordFullkerson e devolve o valor do fluxo máximo.
*/
#include <stdio.h>
#include <locale.h>
#include <stdlib.h>
...
int numVertices, numArestas, numAreasRisco, numAbrigos, inicio, destino, removeu = 0, popAreasRisco = 0, popAbrigos = 0, a =0;
...
/* Função responsável por verifica se existem rotas saindo de todas as áreas de risco
 * verifica para a superorigem se existe fluxo saindo em direção a todos os abrigos.
*/
void escoaFluxo(){
    int limite = numVertices-2;
