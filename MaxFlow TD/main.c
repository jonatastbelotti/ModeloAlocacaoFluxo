...
*  Feito para comparar os resultados do relaxamento das rotas, com rotas totalmente disjuntas
*
* autores: Jônatas Trabuco Belotti e Sheila Morais de Almeida
* data: 11/10/2015
* versão: 2.0_rotas_disjuntas
*
...
int verificaFluxo(){
    ...
    for (int i = 0; i < limite; i++) {
        ...
        // if (grafo[i][i] != -10){
            ...
            // Verifica se mais de um fluxo entra no vértice ou mais de um fluxo sai do vértice
